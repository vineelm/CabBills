...
namespace CabBills
{
    class Invoice
    {
        ...
        {
            string billPath = @"C:\TNow Documents\CabBills\CabBills\HTMLFormats\Invoice.html";
            ...
            foreach (var data in lstBills)
            {
                ...
                {
                    billHTML = billHTML.Replace("$map$", "Walamtari_Kothapet.png");
                }
                else if (data.From == "Kothapet" && data.To == "Walamtari")
                {
                    billHTML = billHTML.Replace("$map$", "Kothapet_Walamtari.png");
                }
                else if (data.From == "peerancheruvu" && data.To == "Walamtari")
                {
                    billHTML = billHTML.Replace("$map$", "Peerancheruvu_Walamtari.png");
                }
                else if (data.From == "Walamtari" && data.To == "peerancheruvu")
                {
                    billHTML = billHTML.Replace("$map$", "Walamtari_Peerancheruvu.png");
                }
                else if (data.From == "peerancheruvu - tolichowki" && data.To == "Walamtari")
                {
                    billHTML = billHTML.Replace("$map$", "Peerancheruvu_Walamtari_via_tolichowki.png");
                }
